...
class ResNet(nn.Module):
    ...
    def __init__(self, block, n_blocks, keep_prob=1.0, avg_pool=True, drop_rate=0.0,
...
def resnet12(rep_size=512, keep_prob=1.0, avg_pool=True, **kwargs):
    """Constructs a ResNet-12 model.
    """
    base_model = ResNet(BasicBlock, [1, 1, 1, 1], keep_prob=keep_prob, avg_pool=avg_pool, **kwargs)
    head = MLPHead(in_chans=640, rep_size=rep_size)
    model = ResNetModel(base_model, head)
    return model
